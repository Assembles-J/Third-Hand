...
ExperimentDefinition identifies exactly which strategy/policy configuration and
which frozen membership snapshot an evaluation belongs to. It is metadata only:
it cannot score decisions, mutate the formal strategy, create paper orders, or
write fills.
"""
...
class ExperimentDefinition(BaseModel):
    ...
    Personal Watchlist/position changes cannot alter the bound universe snapshot.
    """
